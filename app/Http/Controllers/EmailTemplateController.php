   ...
   public function index($lang = 'en')
    {
        ...
        if(\Auth::user()->type == 'Owner')
        {
            ...
            $currEmailTempLang = EmailTemplateLang::where('lang', $lang)->where('parent_id', $id)->first();
            ...
            return view('email_templates.index', compact('emailTemplate', 'languages', 'currEmailTempLang','EmailTemplates','langs'));
        }
        else
        {
    ...
    public function manageEmailLangindex($id="", $lang = 'en')
    {
    ...
    public function update(Request $request, EmailTemplate $emailTemplate)
    {
        ...
        if(\Auth::user()->can('Edit Email Template'))
        {
            ...
            $emailTemplateLang       = EmailTemplateLang::where('parent_id',$emailTemplate->id)->where('lang',$request->lang)->first();
            $emailTemplateLang->content   = $request->content;
    ...
    public function storeEmailLang(Request $request, $id)
    {
        if(\Auth::user()->can('Edit Email Template Lang'))
        {
            ...
            if(empty($emailLangTemplate))
            {
                ...
                $emailTemplateLang->from   = $request['from'];
