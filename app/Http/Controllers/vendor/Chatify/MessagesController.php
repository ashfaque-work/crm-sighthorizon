...
class MessagesController extends Controller
{
    ...
    public function idFetchData(Request $request)
    {
        ...
        {
            $avatar = \App\Models\Utility::get_file('uploads/avatar/'.config('chatify.user_avatar.folder') . '/avatar.png');
        }
    ...
    public function search(Request $request)
    {
        ...
        $records = User::where('created_by', \Auth::user()->ownerId())->where('name', 'LIKE', "%{$input}%");
    ...
    public function getMessagePopup()
    {
        ...
        return view('Chatify::pages.popup', compact('messages'));
    }
