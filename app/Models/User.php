...
class User extends Authenticatable
{
    ...
    public function userDefaultData()
    {
        ...
        $labels = [
            'Ad-Campaign' => ['Lead Source', 'primary'],
            'Justdial' => ['Lead Source', 'primary'],
            'Tawk' => ['Lead Source', 'primary'],
            'Knowlarity' => ['Lead Source', 'primary'],
            'Website' => ['Lead Source', 'primary'],
            'Cold-Calling' => ['Lead Source', 'primary'],
            'Call not received' => ['Call Status', 'warning'],
            'Spam' => ['Call Status', 'warning'],
            'Not interested' => ['Call Status', 'warning'], 
            'Interested' => ['Call Status', 'warning'],
            'Call Later' => ['Call Status', 'warning'], 
            'Price Issue' => ['Call Status', 'warning'],
            'Window Shopper' => ['Call Status', 'warning'],
            'Hot Lead' => ['Kind of Lead', 'danger'], 
            'Warm Lead' => ['Kind of Lead', 'danger'], 
            'Cold Lead' => ['Kind of Lead', 'danger']
        ];
        ...
        $defaultTemplate = [
            'New User' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p>Olá,&nbsp;<br>Bem-vindo ao {app_name}.</p><p><b>E-mail </b>: {email}<br><b>Senha</b> : {password} </p><p>{app_url}</p><p>Obrigado,<br>{app_name}</p>',
                    ...
                    'zh' => '<p>您好，&nbsp;<br>欢迎来到{app_name}。</p><p><b>电子邮件 </b>： {电子邮件}<b>密码</b> ： {密码}{app_url}谢谢，{app_name}<br></p><p></p><p><br></p>',
                    'he' => '<p>שלום,&nbsp;<br>ברוכים הבאים ל{app_name}.</p><p><b>דוא"ל </b>: {email}<b>Password</b> : {password}{app_url}Thanks,{app_name}<br></p><p></p><p><br></p>',
            ...
            'Assign Deal' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p><span style="font-family: sans-serif;">Olá,</span><br style="font-family: sans-serif;"><span style="font-family: sans- serif;">Novo negócio foi atribuído a você.</span></p><p><span style="font-family: sans-serif;"><b>Nome do negócio</b> : {deal_name }<br><b>Canal da transação</b> : {deal_pipeline}<br><b>Estágio da transação</b> : {deal_stage}<br><b>Status da transação</b> : {deal_status}</br><b>Preço da oferta</b> : {deal_price}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;">Merhaba,</span><br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Yeni Anlaşma size Atandı.</span></p><p><span style="font-family: sans-serif;"><b>Deal Name</b> : { deal_name }<br><b>Deal Bora Pipeline</b> : { deal_pipeline }<br><b>Deal Stage</b> : { deal_stage }<br><b>Deal Status</b> : { deal_status }<br><b>Deal Price</b> : { deal_price }</span></p>',
                    'zh' => '<p><span style=“font-family</span>： sans-serif;”>Hello，<br style=“font-family： sans-serif;”><span style=“font-family： sans-serif;”>New Deal 已分配给您。</span></p><p><span style=“font-family： sans-serif;”>交易<b>名称</b> ： {deal_name}交易管道 ： {deal_pipeline}交易阶段 ： {deal_stage}交易状态 ： {deal_status}<b></b><b></b><b>交易价格</b> ： {deal_price}<b></b><br><br><br><br></span></p>',
                    'he' => '<p><span style="font-family</span>: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">New Deal כבר הקצה לך.</span></p><p><span style="font-family: sans-serif;">Deal <b>Name</b> : {deal_name}Deal <b>Pipeline</b> : {deal_pipeline}Deal Stage : {deal_stage}<b>Deal Status</b> : {deal_status}<b>Deal Price</b> : {deal_price}<b></b><br><br><br><br></span></p>',
                    'pt-br' => '<p><</span></span></p>span style="font-family: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">New Deal has been Assign to you.<p><span style="font-family: sans-serif;"><b>Nome</b><b></b> do<b></b> negócio : {deal_name}Pipeline do negócio : {deal_pipeline}Estágio do negócio : {deal_stage}Status do negócio : {deal_status}<b>Preço do negócio</b> : {deal_price<b></b>}<br><br><br><br></span></p>',
                ],
            ],
            'Move Deal' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p><span style="font-family: sans-serif;">Olá,</span><br style="font-family: sans-serif;"><span style="font-family: sans- serif;">Um negócio foi movido de {deal_old_stage} para&nbsp; {deal_new_stage}.</span></p><p><span style="font-family: sans-serif;"><span style="font-weight: bolder;">Nome da oferta</span>&nbsp ;: {deal_name}<br><span style="font-weight: bolder;">Oferta de pipeline</span>&nbsp;: {deal_pipeline}<br><span style="font-weight: bolder;">Oferta Estágio</span>&nbsp;: {deal_stage}<br><span style="font-weight: bolder;">Status da transação</span>&nbsp;: {deal_status}<br><span style="font-weight : bolder;">Preço da oferta</span>&nbsp;: {deal_price}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;">Merhaba,</span><br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Bir anlaşma, { deal_old_stage } öğesinden &nbsp; { deal_new_stage }.</span></p><p><span style="font-family: sans-serif;"><span style="font-weight: bolder;">Deal Name</span>&nbsp;: { deal_name }<br><span style="font-weight: bolder;">Deal Pipeline</span>&nbsp;: { deal_pipeline }<br><span style="font-weight: bolder;">Deal Stage</span>&nbsp;: { deal_stage }<br><span style="font-weight: bolder;">Deal Status</span>&nbsp;: { deal_status }<br><span style="font-weight: bolder;">Deal Price</span>&nbsp;: { deal_price }</span></p>',
                    'zh' => '<p><span style=“font-family</span>： sans-serif;”>Hello，<br style=“font-family： sans-serif;”><span style=“font-family： sans-serif;”>A Deal 已从 {deal_old_stage} 移至&nbsp; {deal_new_stage}。</span></p><p><span style=“font-family： sans-serif;”><</span>span style=“font-weight： bolder;”>Deal Name&nbsp;： {deal_name}<span style=“font-weight： bolder;”>Deal Pipeline ： {deal_pipeline}<span style=“font-weight： bolder;”>Deal Stage ： {deal_stage}<span style=“font-weight： bolder;”>Deal Status ： {deal_status}<span style=“font-weight： bolder;”>Deal Price ： {deal_price}<br></span><br>&nbsp;</span><br>&nbsp;</span><br>&nbsp;</span>&nbsp;</span></p>',
                    'he' => '<p><span style="font-family</span>: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">A Deal הועבר מ- {deal_old_stage} ל&nbsp;- {deal_new_stage}.</span></p><p><span style="font-family: sans-serif</span>;"><span style="font-weight: bolder;">Deal Name&nbsp;: {deal_name}<span style="font-weight: bolder;">Deal Pipeline : {deal_pipeline}<span style="font-weight: bolder;">Deal Stage : {deal_stage}<span style="font-weight: bolder;">Deal Status : {deal_status}<span style="font-weight: bolder;">Deal Price : {deal_price}<br></span><br>&nbsp;</span><br>&nbsp;</span><br>&nbsp;</span>&nbsp;</span></p>',
                    'pt-br' => '<p><</span>span style="font-family: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Um acordo foi movido de {deal_old_stage} para&nbsp; {deal_new_stage}.</span></p><p><span style="font-family: sans-serif</span>;"><span style="font-weight: bolder;">Nome do negócio: {deal_name}<span style="font-weight: bolder;">Deal Pipeline : {deal_pipeline}<span style="font-weight: bolder;">Deal Stage: {deal_stage}<span style="font-weight: bolder;">Status do negócio: {deal_status}<span style="font-weight: bolder;">Preço do negócio&nbsp;: {deal_price}<br></span><br>&nbsp;</span><br>&nbsp;</span><br>&nbsp;</span>&nbsp;</span></p>',
                ],
            ],
            'Create Task' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p><span style="font-family: sans-serif;">Olá,</span><br style="font-family: sans-serif;"><span style="font-family: sans- serif;">Nova tarefa foi atribuída a você.</span></p><p><span style="font-family: sans-serif;"><b>Nome da tarefa</b> : {task_name }<br><b>Prioridade da tarefa</b> : {task_priority}<br><b>Status da tarefa</b> : {task_status}<br><b>Negociação da tarefa</b> : {deal_name}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;">Merhaba,</span><br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Yeni Görev size Atama oldu.</span></p><p><span style="font-family: sans-serif;"><b>Görev Adı</b> : { task_name }<br><b>Görev Önceliği</b> : { task_priority }<br><b>Görev Durumu</b> : { task_status }<br><b>Görev Anlaşması</b> : { deal_name }</span></p>',
                    'zh' => '<p><span style=“font-family</span>： sans-serif;”>你好，<br style=“font-family： sans-serif;”><span style=“font-family： sans-serif;”>新任务已分配给您。</span></p><p><span style=“font-family： sans-serif;”>任务<b>名称</b> ： {task_name}任务优先级 ： {task_priority}任务状态 ： {task_status}<b></b><b>任务处理</b> ：<b></b> {deal_name}<br><br><br></span></p>',
                    'he' => '<p><span style="font-family</span>: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">משימה חדשה הוקצתה לך.</span></p><p><span style="font-family: sans-serif;"><b>שם</b> משימה : {task_name}<b>עדיפות</b> משימה : {task_priority}<b>מצב משימה</b> : {task_status}<b>Task Deal</b> : {deal_name}<br><br><br></span></p>',
                    'pt-br' => '<p><</span></span></p>span style="font-family: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Nova tarefa foi atribuída a você.<p><span style="font-family: sans-serif;"><b>Nome da</b> tarefa : {task_name}Prioridade da tarefa : {task_priority}<b>Status da tarefa</b> : {task_status}<b>Negócio</b> da <b>tarefa</b> : {deal_name}<br><br><br></span></p>',
                ],
            ],
            'Assign Lead' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p><span style="font-family: sans-serif;">Olá,</span><br style="font-family: sans-serif;"><span style="font-family: sans- serif;">Novo lead foi atribuído a você.</span></p><p><span style="font-family: sans-serif;"><b>Nome do lead</b> : {lead_name }<br><b>Lead Email</b> : {lead_email}<br><b>Lead Pipeline</b> : {lead_pipeline}<br><b>Lead Stage</b> : {lead_stage}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;">Merhaba,</span><br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Yeni Lider size Atandı.</span></p><p><span style="font-family: sans-serif;"><b>Ön Adım</b> : { lead_name }<br><b>Lead Email</b> : { lead_email }<br><b>Lead Pipeline</b> : { lead_pipeline }<br><b>Lead Stage</b> : { lead_stage }</span></p>',
                    'zh' => '<p><span style=“font-family</span>： sans-serif;”>你好，<br style=“font-family： sans-serif;”><span style=“font-family： sans-serif;”>New Lead 已分配给您。</span></p><p><span style=“font-family： sans-serif;”>潜在客户<b>名称</b> ： {lead_name}潜在客户电子邮件 ： {lead_email}潜在客户管道 ： {lead_pipeline}<b></b><b>潜在客户阶段</b> ：<b></b> {lead_stage}<br><br><br></span></p>',
                    'he' => '<p><span style="font-family</span>: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">הפניה חדשה הוקצתה לך.</span></p><p><span style="font-family: sans-serif;"><b>שם הפניה</b> : {lead_name}Lead <b>Email</b> : {lead_email}Lead <b>Pipeline</b> : {lead_pipeline}<b>Lead Stage</b> : {lead_stage}<br><br><br></span></p>',
                    'pt-br' => '<p><</span></span></p>span style="font-family: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">New Lead has been Assign to you.<p><span style="font-family: sans-serif;"><b>Nome do lead</b> : {lead_name}<b>Lead Email</b> : {lead_email}Lead <b>Pipeline</b> : {lead_pipeline}<b>Lead Stage</b> : {lead_stage}<br><br><br></span></p>',
                ],
            ],
            'Move Lead' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p><span style="font-family: sans-serif;">Olá,</span><br style="font-family: sans-serif;"><span style="font-family: sans- serif;">Um lead foi movido de {lead_old_stage} para&nbsp; {lead_new_stage}.</span></p><p><span style="font-weight: bolder; font-family: sans-serif;">Nome do lead</span><span style="font-family : sans-serif;">&nbsp;: {lead_name}</span><br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif ;">E-mail principal</span><span style="font-family: sans-serif;">&nbsp;: {lead_email}</span><br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Lead Pipeline</span><span style="font-family: sans-serif;">&nbsp;: {lead_pipeline}</span><br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Estágio Principal</span><span style="font- family: sans-serif;">&nbsp;: {lead_stage}</span><span style="font-family: sans-serif;"><br></span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;">Merhaba,</span><br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Bir Lider, { lead_old_stage } dan &nbsp; { lead_new_stage }.</span></p><p><span style="font-weight: bolder; font-family: sans-serif;">Lider Adı</span><span style="font-family: sans-serif;">&nbsp;: { lead_name }</span><br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Lead Email</span><span style="font-family: sans-serif;">&nbsp;: { lead_email }</span><br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Lead Pipe Pipeline</span><span style="font-family: sans-serif;">&nbsp;: { lead_pipeline }</span><br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Ön Aşama</span><span style="font-family: sans-serif;">&nbsp;: { lead_stage }</span><span style="font-family: sans-serif;"><br></span></p>',
                    'zh' => '<p><span style=“font-family</span>： sans-serif;”>Hello，<br style=“font-family： sans-serif;”><span style=“font-family： sans-serif;”>A Lead 已从 {lead_old_stage} 移动到&nbsp; {lead_new_stage}。</span></p><p><span style=“font-weight</span>： bolder; font-family： sans-serif;”>Lead Name<span style=“font-family： sans-serif;”> ： {lead_name}<br style=“font-family： sans-serif;”><span style=“font-weight： bolder; font-family： sans-serif;”>Lead Email<span style=“font-family： sans-serif;”> ： {lead_email}<br style=“font-family： sans-serif;”><span style=“font-weight： bolder; font-family： sans-serif;”>&nbsp;Lead Pipeline<span style=“font-family： sans-serif;”</span></span>&nbsp;</span></span>&nbsp;></span></span> ： {lead_pipeline}<br style=“font-family： sans-serif;”><span style=“font-weight： bolder; font-family： sans-serif;”>Lead Stage<span style=“font-family： sans-serif;”>&nbsp;： {lead_stage}<span style=“font-family： sans-serif;”></span><br></span></p>',
                    'he' => '<p><span style="font-family</span>: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">A Lead הועבר מ- {lead_old_stage} ל&nbsp;- {lead_new_stage}.</span></p><p><span style="font-weight</span>: bolder; font-family: sans-serif;">Lead Name<span style="font-family: sans-serif;"> : {lead_name}<br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Lead Email<span style="font-family: sans-serif;"> : {lead_email}<br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">&nbsp;Lead Pipeline<span style="font-family: sans-serif;"</span></span>&nbsp;</span></span> &nbsp;></span></span> : {lead_pipeline}<br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Lead Stage<span style="font-family: sans-serif;"> : {lead_stage}<span style="font-family: sans-serif;">&nbsp;</span><br></span></p>',
                    'pt-br' => '<p><</span>span style="font-family: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">A Lead foi movida de {lead_old_stage} para&nbsp; {lead_new_stage}.</span></p><p><</span>span style="font-weight: negrito; font-family: sans-serif;">Lead Name<span style="font-family: sans-serif;"> : {lead_name}<br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Lead Email<span style="font-family: sans-serif;"> : {lead_email}<br style="font-family: sans-serif;"><span style="font-weight: negrito; font-family: sans-serif;">&nbsp;Lead Pipeline<span style="font-family: sans-serif;"</span></span>&nbsp;</span></span> &nbsp;></span></span> : {lead_pipeline}<br style="font-family: sans-serif;"><span style="font-weight: bolder; font-family: sans-serif;">Lead Stage<span style="font-family: sans-serif;"> : {lead_stage}<span style="font-family: sans-serif;">&nbsp;</span><br></span></p>',
                ],
            ],
            'Assign Estimation' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p><span style="font-family: sans-serif;">Olá,</span><br style="font-family: sans-serif;"><span style="font-family: sans- serif;">Nova estimativa foi atribuída a você.</span></p><p><span style="font-family: sans-serif;"><b>ID de estimativa</b>: {estimation_name }<br><b>Cliente de estimativa</b> : {estimation_client}<br><b>Status de estimativa</b> : {estimation_status}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;">Merhaba,</span><br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Yeni Tahminler size Atandı.</span></p><p><span style="font-family: sans-serif;"><b>Tahmin Tanıtıcısı</b>: { estimation_name }<br><b>Tahmin İstemcisi</b> : { estimation_client }<br><b>Tahmin Durumu</b> : { estimation_status }</span></p>',
                    'zh' => '<p><span style=“font-family</span>： sans-serif;”>Hello，<br style=“font-family： sans-serif;”><span style=“font-family： sans-serif;”>New Estimation 已分配给您。</span></p><p><span style=“font-family： sans-serif;”>Estimation <b>Id</b>： {estimation_name}Estimation Client ： {estimation_client}<b>Estimation Status</b> ： {estimation_status}<br><b></b><br></span></p>',
                    'he' => '<p><span style="font-family</span>: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">הערכה חדשה הוקצתה לך.</span></p><p><span style="font-family: sans-serif;">מזהה <b>הערכה</b>: {estimation_name}<b>לקוח הערכה</b> : {estimation_client}<b>Estimation Status</b> : {estimation_status}<br><br></span></p>',
                    'pt-br' => '<p><</span></span></p>span style="font-family: sans-serif;">Hello,<br style="font-family: sans-serif;"><span style="font-family: sans-serif;">Nova estimativa foi atribuída a você.<p><span style="font-family: sans-serif;">Estimation Id: {estimation_name}<b>Estimation Client</b> : {estimation_client}<b>Status da estimativa</b> : {estimation_status}<b></b><br><br></span></p>',
                ],
            ],
            'Contract' => [
                'subject' => 'Contract',
                'lang' => [
                    ...
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;"><strong>Merhaba </strong>{ contract_client } </span></p>
                    ...
                    <p><span style="font-family: sans-serif;">Duymayı dört gözle bekliyorum. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Tür Saygılarımızla, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{ company_name }</span></p>',
                    'zh' => '<p><span style=“font-family： sans-serif;”><strong>Hi </strong>{contract_client} </span></p>
                    <p><span style=“font-family： sans-serif;”><strong>contract Subject：</strong> {contract_subject} </span></p>
                    <p><strong><span style=“font-family</span></strong>： sans-serif;”>S<span style=“font-family： sans-serif;”><strong>tart Date</strong>： {contract_start_date} </span></p>
                    <p><span style=“font-family： sans-serif;”><strong>End Date</strong>： {contract_end_date} </span></p>
                    <p><span style=“font-family： sans-serif;”>期待收到您的来信。 </span></p>
                    <p><strong><span style=“font-family： sans-serif;”>亲切的问候， </span></strong></p>
                    <p><span style=“font-family： sans-serif;”>{company_name}</span></p>',
                    'he' => '<p><span style="font-family: sans-serif;"><strong>Hi </strong>{contract_client} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Contract Subject:</strong> {contract_subject} </span></p>
                    <p><strong><span style="font-family</span></strong>: sans-serif;">S<span style="font-family: sans-serif;"><strong>tart תאריך</strong>: {contract_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>End Date</strong>: {contract_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">מצפה לשמוע ממך. </span></p>
                    <p><strong><span style="font-family: sans-serif;">בברכה, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pt-br' => '<p><span style="font-family: sans-serif;"><strong>Oi </strong>{contract_client} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Assunto do contrato:</strong> {contract_subject} </span></p>
                    <p><strong><</span></strong>span style="font-family: sans-serif;">S<span style="font-family: sans-serif;"><strong>tart Data</strong>: {contract_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data de término</strong>: {contract_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">Ansioso para ouvir de você. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Atenciosamente, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                ],
            ],
        ];
...
public static function enable_chatgpt(){
    $user = User::where('id', '=', \Auth::user()->ownerId())->first();
    $settings = Utility::settings();
