...
Route::controller(UserLogController::class)->middleware('auth','XSS')->group(function(){
    Route::get('/users/user-logs', 'index')->name('userlog.index');
    Route::get('/users/user-logs/{id}', 'show')->name('userlog.show');
    Route::delete('/users/user-logs/{id}', 'destroy')->name('userlog.destroy');
});
...
//language
Route::post('disable-language',[UserController::class,'disableLang'])->name('disablelanguage')->middleware(['auth','XSS']);
...
Route::post('/seo-settings', [SettingsController::class, 'saveSeoSettings'])->middleware('auth','XSS')->name('seo.settings.store');
Route::post('/clear-cache', [SettingsController::class, 'ClearCache'])->middleware('auth','XSS')->name('clear.cache');
...
Route::resource('notification_template', NotificationTemplatesController::class)->middleware(
    [
        'auth',
        'XSS',
    ]
);
// Route::get('notification-templates/{id?}/{lang?}/', [NotificationTemplatesController::class, 'index'])->name('notification_templates.index')->middleware('auth','XSS');
Route::get('notification-templates/{id?}/{lang?}/{type?}', [NotificationTemplatesController::class, 'index'])->name('notification-templates.index');
...
Route::resource('deals', DealController::class)->middleware('XSS','auth');
...
Route::resource('leads', LeadController::class)->middleware('XSS','auth');
...
Route::resource('estimations', EstimationController::class)->middleware('XSS','auth');
...
// Form Builder
Route::resource('form_builder', FormBuilderController::class)->middleware('XSS','auth');
...
Route::resource('mdf', MdfController::class)->middleware('XSS','auth');
Route::post('/mdf/event_type', [MdfController::class, 'jsonEvent'])->name('mdf.event.json');
Route::resource('mdf_status', MdfStatusController::class)->middleware('XSS','auth');
Route::resource('mdf_type', MdfTypeController::class)->middleware('XSS','auth');
Route::resource('mdf_sub_type', MdfSubTypeController::class)->middleware('XSS','auth');
...
Route::delete('/invoice/{id}', [BankTransferController::class, 'invoicepaymentdestroy'])->middleware('auth','XSS')->name('payment.destroy');
Route::delete('/banktransfer-invoice/{id}', [BankTransferController::class, 'banktransferdestroy'])->middleware('auth','XSS')->name('payment.delete');
Route::get('/invoice-payment/{id}', [BankTransferController::class, 'InvoicePaymentStatus'])->middleware('auth','XSS')->name('payment.show');
Route::get('/invoice-approval/{id}', [BankTransferController::class, 'InvoicePaymentApproval'])->middleware('auth','XSS')->name('payment.approval');
...
Route::post('/invoice/paytm', [PaytmPaymentController::class, 'getInvociePaymentStatus'])->name('invoice.paytm');
...
Route::post('/invoice-pay-with-toyyibpay', [ToyyibpayController::class, 'invoicepaywithtoyyibpay'])->name('toyyibpay.invoice')->middleware(['XSS']);
...
Route::post('/invoice-with-payfast', [PayfastController::class, 'invoicepaywithpayfast'])->name('payfast.invoice')->middleware(['XSS']);
Route::get('/invoice-pay-with-payfast/{success}', [PayfastController::class, 'invoicepayfaststatus'])->name('invoice.payfast')->middleware(['XSS']);

Route::post('/customer-pay-with-sspay', [SspayController::class,'invoicepaywithsspaypay'])->name('invoice.pay.with.sspay');
Route::get('/customer/sspay/{invoice}/{amount}', [SspayController::class,'getInvoicePaymentStatus'])->name('customer.sspay');

Route::post('/customer-pay-with-paytab', [PaytabController::class,'invoicepaywithpaytabpay'])->name('invoice.pay.with.paytab');
Route::get('/customer/paytab/{invoice}/{amount}', [PaytabController::class,'getInvoicePaymentStatus'])->name('customer.paytab');

Route::post('/customer-pay-with-benefit', [BenefitPaymentController::class,'invoicepaywithbenefit'])->name('invoice.pay.with.benefit');
Route::get('/customer/beneift/{invoice}/{amount}', [BenefitPaymentController::class,'getInvoicePaymentStatus'])->name('customer.benefit');


Route::post('/customer-pay-with-cashefree', [CashfreeController::class,'invoicepaywithcashefree'])->name('invoice.pay.with.cashefree');
Route::get('/customer/cashefree/', [CashfreeController::class,'getInvoicePaymentStatus'])->name('customer.cashefree');

Route::post('/customer-pay-with-aamarpay', [AamarpayController::class,'invoicepaywithaamarpay'])->name('invoice.pay.with.aamarpay');
Route::any('/customer/aamarpay/{data}', [AamarpayController::class,'getInvoicePaymentStatus'])->name('customer.aamarpay');

Route::post('customer-pay-with-paytr/', [PaytrController::class, 'invoicePayWithpaytr'])->name('invoice.with.paytr');
Route::any('customer/paytr-status/', [PaytrController::class, 'getInvociePaymentStatus'])->name('invoice.paytr.status');
...
Route::any('invoice-with-midtrans/', [MidtransController::class, 'invoicePayWithMidtrans'])->name('invoice.with.midtrans')->middleware(['XSS']);
Route::any('invoice-midtrans-status/', [MidtransController::class, 'getInvociePaymentStatus'])->name('invoice.midtrans.status')->middleware(['XSS']);

Route::any('/invoice-with-xendit', [XenditPaymentController::class, 'invoicePayWithXendit'])->name('invoice.with.xendit')->middleware(['XSS']);
Route::any('/invoice-xendit-status', [XenditPaymentController::class, 'getInvociePaymentStatus'])->name('invoice.xendit.status')->middleware(['XSS']);
...
Route::post('setting/google-calender',[SettingsController::class,'saveGoogleCalenderSettings'])->name('google.calender.settings');
...
/*==================================Report====================================================*/
Route::get('lead-report', [ReportController::class, 'leadReport'])->name('report.lead')->middleware('auth','XSS');
Route::get('deal-report', [ReportController::class, 'dealReport'])->name('report.deal')->middleware('auth','XSS');
Route::get('invoice-report', [ReportController::class, 'invoicereport'])->name('report.invoice')->middleware('auth','XSS');
Route::get('expenses-summary', [ReportController::class, 'expensesreport'])->name('report.expenses')->middleware('auth','XSS');
Route::get('income-vs-expense-summary', [ReportController::class, 'incomeVsExpenseSummary'])->name('report.income.vs.expense.summary')->middleware('auth','XSS');
