                    ...
                    <div class="preview-main client-preview">
                        <div data-v-e23d9750="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e23d9750="" class="d-inner">
                                ...
                                <div data-v-e23d9750="" class="row justify-content-between">
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-right">{{$usr->invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Deal')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{$invoice->deal->name}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{$usr->dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Due Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{$usr->dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                ...
                                <div data-v-e23d9750="" class="d-table">
                                    <div data-v-e23d9750="" class="d-table">
                                        <div data-v-e23d9750="" class="tu d-table-tr" style="border-bottom: 2px solid {{$color}};">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-th w-13">{{__('Item Name')}}</div>
                                        ...
                                        <div data-v-e23d9750="" class="d-table-footer">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-summary">
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-e23d9750="" class="d-table-value">{{$usr->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div data-v-e23d9750="" class="d-table-summary-item">
                                                        <div data-v-e23d9750="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-e23d9750="" class="d-table-value">{{$usr->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->getTax())
                                                    <div data-v-e23d9750="" class="d-table-summary-item">
                                                        <div data-v-e23d9750="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-e23d9750="" class="d-table-value">{{$usr->priceFormat($invoice->getTax())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="fwb f-b tu d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-e23d9750="" class="fwb f-b d-table-value">{{$usr->priceFormat($invoice->getSubTotal()-$invoice->discount+$invoice->getTax())}}</div>
                                                </div>
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-e23d9750="" class="d-table-value">{{$usr->priceFormat($invoice->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
