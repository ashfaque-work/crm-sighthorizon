                    ...
                    <div class="preview-main client-preview">
                        <div data-v-363339a0="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                ...
                                <div data-v-363339a0="" class="row justify-content-between">
                                    ...
                                    <div data-v-363339a0="" class="col-33">
                                        <table data-v-363339a0="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{$usr->invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Deal')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$invoice->deal->name}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$usr->dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Due Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$usr->dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            <tr class="" style="height: 110px;">
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 2px solid {{$color}}; border-top: 2px solid {{$color}};">
                                            ...
                                            <div data-v-363339a0="" class="d-table-th w-13">{{__('Item Name')}}</div>
                                        ...
                                        <div data-v-363339a0="" class="d-table-footer">
                                            ...
                                            <div data-v-363339a0="" class="d-table-summary">
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->getTax())
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($invoice->getTax())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="fwb f-b tu d-table-label" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Total')}}:</div>
                                                    <div data-v-363339a0="" class="fwb f-b d-table-value" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{$usr->priceFormat($invoice->getSubTotal()-$invoice->discount+$invoice->getTax())}}</div>
                                                </div>
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($invoice->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
