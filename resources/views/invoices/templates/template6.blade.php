                            ...
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        <strong data-v-4b3dcb8a="">{{ __('From') }}:</strong>
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-2" style="padding-left: 50px">
                                        <div data-v-4b3dcb8a="" class="col-66">
                                            <strong data-v-4b3dcb8a="">{{__('To')}}:</strong>
                                ...
                                <div data-v-4b3dcb8a="" class="">
                                    <div data-v-4b3dcb8a="" class="">
                                        <table data-v-4b3dcb8a="" class="no-space">
                                            <tbody data-v-4b3dcb8a="" style="position: relative">
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Number')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{$usr->invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Deal')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{$invoice->deal->name}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{$usr->dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{$usr->dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            <tr class="ml-8 " style="height: 110px;">
                                ...
                                <div data-v-4b3dcb8a="" class="d-table">
                                    <div data-v-4b3dcb8a="" class="d-table">
                                        <div data-v-4b3dcb8a="" class="tu d-table-tr" style="background: {{$color}}; padding: 5px;color: {{$font_color}}">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-th w-13">{{__('Item Name')}}</div>
                                        ...
                                        <div data-v-4b3dcb8a="" class="d-table-footer">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-summary">
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-value">{{$usr->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>

                                                @if($invoice->discount)
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">{{$usr->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->getTax())
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">{{$usr->priceFormat($invoice->getTax())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><strong data-v-4b3dcb8a="">{{__('Total')}}:</strong></div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><strong data-v-4b3dcb8a="">{{$usr->priceFormat($invoice->getSubTotal()-$invoice->discount+$invoice->getTax())}}</strong></div>
                                                </div>
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value">{{$usr->priceFormat($invoice->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
