                            ...
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    ...
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('INVOICE')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="no-space">
                                            <tbody data-v-1ad6e3b9="" style="position: relative;">
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Number')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$usr->invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Deal')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$invoice->deal->name}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$usr->dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$usr->dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                    ...
                                    <div data-v-1ad6e3b9="" class="d-table">
                                        <div data-v-1ad6e3b9="" class="d-table">
                                            <div data-v-1ad6e3b9="" class="tu d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-th w-13" style="padding: 5px;">{{__('Item Name')}}</div>
                                            ...
                                            <div data-v-1ad6e3b9="" class="d-table-footer">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-summary">
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($invoice->getSubTotal())}}</div>
                                                    </div>
                                                    @if($invoice->discount)
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($invoice->discount)}}</div>
                                                        </div>
                                                    @endif
                                                    @if($invoice->getTax())
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($invoice->getTax())}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label"><strong data-v-1ad6e3b9="">{{__('Total')}}:</strong></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value"><strong data-v-1ad6e3b9="">{{$usr->priceFormat($invoice->getSubTotal()-$invoice->discount+$invoice->getTax())}}</strong></div>
                                                    </div>
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($invoice->getDue())}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
