                            ...
                            <div data-v-b8f60a0c="" class="d-inner">
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="col-33" class="summary-table">
                                            <tbody data-v-b8f60a0c="">
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Number')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$usr->invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Deal')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$invoice->deal->name}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$usr->dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Due Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$usr->dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            <tr class="ml-8 " style="right: 0; position: relative;">
                                ...
                                <div data-v-b8f60a0c="" class="d-table">
                                    <div data-v-b8f60a0c="" class="d-table">
                                        <div data-v-b8f60a0c="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 1px solid {{$color}}; border-top: 1px solid {{$color}};">
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-th w-13">{{__('Item Name')}}</div>
