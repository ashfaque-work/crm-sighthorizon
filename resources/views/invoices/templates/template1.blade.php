                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        <div data-v-f2a183a6="" class="d-header-brand" style="padding-top:4px;">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="no-space" >
                                            <tbody data-v-f2a183a6=""style="position: relative;">
                                            <tr>
                                                <td>{{__('Number')}}:</td>
                                                <td>{{$usr->invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Deal')}}:</td>
                                            ...
                                            <tr>
                                                <td>{{__('Issue Date')}}:</td>
                                                <td>{{$usr->dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Due Date')}}:</td>
                                                <td>{{$usr->dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            <tr class="ml-8 " style="position: absolute; right: 0; top: 127px;">
                                                <td class="">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($invoice->getSubTotal())}}</div>
                                                    </div>
                                                    @if($invoice->discount)
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($invoice->discount)}}</div>
                                                        </div>
                                                    @endif
                                                    @if($invoice->getTax())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($invoice->getTax())}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$border_color}}; border-bottom: 1px solid {{$border_color}};">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($invoice->getSubTotal()-$invoice->discount+$invoice->getTax())}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$border_color}}; border-bottom: 1px solid {{$border_color}};">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Due Amount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($invoice->getDue())}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
