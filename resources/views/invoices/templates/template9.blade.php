                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-3">
                                        <h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('INVOICE')}}</h1>
                                        </div>
                                    <div data-v-7d9d14b5="" class="col-3">
                                        <div data-v-7d9d14b5="" class="">
                                            <table data-v-7d9d14b5="" class="no-space" style="width:50%">
                                                <tbody data-v-7d9d14b5="" style="position: relative;">
                                                <tr data-v-7d9d14b5="">
                                                    <td data-v-7d9d14b5="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Number')}}:</td>
                                                    <td data-v-7d9d14b5="" class="">{{$usr->invoiceNumberFormat($invoice->invoice_id)}}</td>
                                                </tr>
                                                <tr data-v-7d9d14b5="">
                                                    <td data-v-7d9d14b5="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Deal')}}:</td>
                                                    <td data-v-7d9d14b5="" class="">{{$invoice->deal->name}}</td>
                                                </tr>
                                                <tr data-v-7d9d14b5="">
                                                    <td data-v-7d9d14b5="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Issue Date')}}:</td>
                                                    <td data-v-7d9d14b5="" class="">{{$usr->dateFormat($invoice->issue_date)}}</td>
                                                </tr>
                                                <tr data-v-7d9d14b5="">
                                                    <td data-v-7d9d14b5="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Due Date')}}:</td>
                                                    <td data-v-7d9d14b5="" class="">{{$usr->dateFormat($invoice->due_date)}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
                                    <div data-v-7d9d14b5="" class="col-1">
                                        <img data-v-7d9d14b5="" class="d-logo" src="{{$img}}" style="max-width: 150px;">
                                    </div>
                                <div data-v-7d9d14b5="" class="break-25"></div>
                                </div>
                                    <div data-v-7d9d14b5="" class="row">
                                        <div data-v-7d9d14b5="" class="col-12" style="width: 80%">
                                            <h3 data-v-7d9d14b5="" class="sub-title" style="padding-top: 14px">@if($settings['company_name']){{$settings['company_name']}}@endif</h3>
                                    ...
                                    <div data-v-7d9d14b5="" class="d-bill-to"><strong data-v-7d9d14b5="">{{__('Bill To')}}:</strong>
                                        <p>
                                            {{$client->name}}<br>
                                            {{$client->email}}
                                        </p>
                                ...
                                <div data-v-7d9d14b5="" class="d-table">
                                    <div data-v-7d9d14b5="" class="d-table">
                                        <div data-v-7d9d14b5="" class="tu d-table-tr" style="color: {{$font_color}}; background: {{$color}};">
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-th w-13" style="padding: 3px;">{{__('Item Name')}}</div>
                                        ...
                                        <div data-v-7d9d14b5="" class="d-table-footer">
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-summary">
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                        <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->getTax())
                                                    <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                        <div data-v-7d9d14b5="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($invoice->getTax())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-7d9d14b5="" class="d-table-summary-item" style="background: {{$color}}; color: {{$font_color}};">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($invoice->getSubTotal()-$invoice->discount+$invoice->getTax())}}</div>
                                                </div>
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($invoice->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
