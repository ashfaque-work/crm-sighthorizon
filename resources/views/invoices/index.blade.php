                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($invoice->status == 0)
                                            ...
                                            <span class="badge rounded p-2 px-3 bg-secondary">{{ __(\App\Models\Invoice::$statues[0]) }}</span>
                                        ...
                                        <span class="badge rounded p-2 px-3 bg-primary">{{ __(\App\Models\Invoice::$statues[3]) }}</span>
