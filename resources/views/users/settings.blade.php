@php
    ...
    $color = isset($setting['color']) ? $setting['color'] : 'theme-4';
                                                ...
                                                <h2 class="accordion-header" id="heading-2-13">
                                                    <button class="accordion-button collapsed" type="button"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="me-2">{{__('On/Off:')}}</span></label>
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <input type="checkbox" name="recaptcha_module" id="recaptcha_module" data-toggle="switchbutton" {{ env('RECAPTCHA_MODULE') == 'on' ? 'checked="checked"' : '' }} value="on" data-onstyle="primary">
