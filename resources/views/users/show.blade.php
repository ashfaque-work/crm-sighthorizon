                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h4 class="text-info">{{ $cnt_deal['this_month'] }} / {{$cnt_deal['cnt_this_month']}}</h4>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h4 class="text-warning">{{ $cnt_deal['this_week'] }} / {{$cnt_deal['cnt_this_week']}}</h4>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h4 class="text-danger">{{ $cnt_deal['last_30days'] }} / {{$cnt_deal['cnt_last_30days']}}</h4>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h4 class="text-info">{{ $cnt_mdf['this_month'] }} / {{$cnt_mdf['cnt_this_month']}}</h4>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h4 class="text-warning">{{ $cnt_mdf['this_week'] }} / {{$cnt_mdf['cnt_this_week']}}</h4>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h4 class="text-danger">{{ $cnt_mdf['last_30days'] }} / {{$cnt_mdf['cnt_last_30days']}}</h4>
                        </div>
                        <div class="col-auto">
