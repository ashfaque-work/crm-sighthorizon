...
<div class="modal-body">
    <div class="row">
        ...
        <div class="text-end">
            <a href="#" data-size="lg" class="btn btn-sm btn-primary btn-icon" data-ajax-popup-over="true" data-url="{{ route('generate',['expense']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Expenses Description') }}">
        ...
        <div class="col-6 form-group">
            ...
            {{ Form::select('user_id', [],null, array('class' => 'form-control select2 multi-select','required'=>'required')) }}
        </div>
