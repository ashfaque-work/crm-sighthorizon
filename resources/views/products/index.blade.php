...
@section('action-button')
        ...
        @can('Create Product')
                <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create Product')}}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Product & Services')}}" data-url="{{route('products.create')}}"><i class="ti ti-plus text-white"></i></a>
        @endcan
@endsection
