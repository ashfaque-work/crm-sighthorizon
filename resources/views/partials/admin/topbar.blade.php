            ...
            <ul class="list-unstyled">
                ...
                @if (\Auth::user()->type != 'Super Admin')
                    <li class="dropdown dash-h-item">
                        ...
                        <div id="omnisearch"
                            class="dropdown-menu dash-h-dropdown drp-search omnisearch drp-search-custom">
                            <form class="px-3">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    <i data-feather="search"></i>
                                    <input type="text" class="form-control border-0 shadow-none search_keyword"
                ...
                <li class="dropdown dash-h-item drp-company">
                    <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                        ...
                        <span class="theme-avtar">
                            ...
                            <img src="{{ !empty(\Auth::user()->avatar) ? \App\Models\Utility::get_file(\Auth::user()->avatar) : $logo . 'avatar.png' }}"
                ...
                @if (Auth::user()->type != 'Super Admin' && Auth::user()->type != 'Client')
                    <li class="dash-h-item">
                        <a class="dash-head-link me-0" href="{{ url('chats') }}">
                            ...
                            <span
                                class="bg-danger dash-h-badge message-toggle-msg message-counter custom_messanger_counter ">{{ $unseenCounter }}<span
                ...
                @if (\Auth::user()->type != 'Super Admin')
                    <li class="dropdown dash-h-item drp-notification">
                        <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown"
                            ...
                            <span class="bg-danger dash-h-badge @if (count($notifications)) dots @endif "><span
                                    class="sr-only"></span></span>
                        </a>
                    ...
                    <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                        ...
                        @foreach (\App\Models\Utility::languages() as $code => $lang)
                            <span class="drp-text hide-mob"
                                style="margin-left: 2px;">{{ $currantLang == $code ? Str::ucfirst($lang) : '' }}</span>
                        @endforeach
