    ...
    <div class="navbar-wrapper">
            ...
            <ul class="dash-navbar">
                ...
                @if (Gate::check('Manage Users') ||
                    ...
                    @can('Manage Users')
                        <li class="dash-item  {{ request()->is('users*') ? 'active' : '' }}">
                            <a href="{{ route('users') }}" class="dash-link"><span class="dash-micon"><i
                    ...
                    @can('Manage Clients')
                        <li class="dash-item {{ request()->is('clients*') ? 'active' : '' }}">
                            <a href="{{ route('clients.index') }}" class="dash-link"><span class="dash-micon"><i
                    ...
                    @can('Manage Roles')
                        <li class="dash-item  {{ Request::route()->getName() == 'roles.index' ? 'active' : '' }}">
                            <a href="{{ route('roles.index') }}" class="dash-link"><span class="dash-micon"><i
                                        class="ti ti-user-x"></i></span><span
                ...
                @can('Manage Deals')
                    <li class="dash-item  {{ request()->is('deals*') ? 'active' : '' }}">
                        <a href="{{ route('deals.index') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-rocket"></i></span><span class="dash-mtext">{{ __('Deals') }}</span></a>
                    </li>
                @endcan
                ...
                @if (Gate::check('Manage Products'))
                    @can('Manage Products')
                        <li class="dash-item {{ Request::route()->getName() == 'products.index' ? 'active' : '' }}">
                            <a href="{{ route('products.index') }}" class="dash-link"><span class="dash-micon"><i
                                        class="ti ti-plane-departure"></i></span><span
                                    class="dash-mtext">{{ __('Products & Services') }}</span></a>
                        </li>
                    @endcan
                @endif
                ...
                @can('Manage Estimations')
                    <li
                        class="dash-item {{ Request::route()->getName() == 'estimations.index' || Request::route()->getName() == 'estimations.show' ? 'active' : '' }}">
                        <a href="{{ route('estimations.index') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-shopping-cart-plus"></i></span><span
                                class="dash-mtext">{{ __('Estimations') }}</span></a>
                    </li>
                @endcan
                ...
                @if (Gate::check('Manage Expenses') || Gate::check('Manage Invoices'))
                    @can('Manage Invoices')
                        <li
                            class="dash-item {{ Request::route()->getName() == 'invoices.index' || Request::route()->getName() == 'invoices.show' ? 'active' : '' }}">
                            <a href="{{ route('invoices.index') }}" class="dash-link"><span class="dash-micon"><i
                    ...
                    @can('Manage Expenses')
                        <li
                            class="dash-item {{ Request::route()->getName() == 'expenses.index' || Request::route()->getName() == 'expenses.show' ? 'active' : '' }}">
                            <a href="{{ route('expenses.index') }}" class="dash-link"><span class="dash-micon"><i
                                        class="ti ti-cash"></i></span><span
                                    class="dash-mtext">{{ __('Expenses') }}</span></a>
                        </li>
                    @endcan
                @endif
                ...
                @can('Manage Invoice Payments')
                    <li class="dash-item {{ Request::route()->getName() == 'invoices.payments' ? 'active' : '' }}">
                        <a href="{{ route('invoices.payments') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-report-money"></i></span><span
                                class="dash-mtext">{{ __('Payments') }}</span></a>
                    </li>
                @endcan

                @can('Manage Form Builders')
                    <li
                        class="dash-item {{ request()->is('form_builder*') || request()->is('form_response*') ? 'active' : '' }}">
                        <a href="{{ route('form_builder.index') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-notebook"></i></span><span
                                class="dash-mtext">{{ __('Form Builder') }}</span></a>
                    </li>
                @endcan

                @if (Gate::check('Manage MDFs') && \App\Models\Utility::checkPermissionExist('Manage MDFs') != 0)
                    <li
                        class="dash-item {{ Request::route()->getName() == 'mdf.index' || Request::route()->getName() == 'mdf.show' ? 'active' : '' }}">
                        <a href="{{ route('mdf.index') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-cash-banknote"></i></span><span
                                class="dash-mtext">{{ __('MDF') }}</span></a>
                    </li>
                @endif
                ...
                @if (\Auth::user()->type == 'Owner' || Gate::check('Manage Contracts'))
                    <li
                ...
                @if (Auth::user()->type != 'Super Admin')
                    <li class="dash-item {{ request()->is('zoommeeting*') ? 'active' : '' }}">
                        <a href="{{ route('zoommeeting.index') }}" class="dash-link"><span class="dash-micon"><i
                    ...
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            ...
                            @if (Gate::check('Invoice Report') || Gate::check('Expense Report') || Gate::check('Income vs Expense Report'))
                                @can('Invoice Report')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'report.invoice' ? ' active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('report.invoice') }}">{{ __('Invoice') }}</a>
                                    </li>
                                @endcan
                                @can('Expense Report')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'report.expense' ? ' active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('report.expenses') }}">{{ __('Expense') }}</a>
                                    </li>
                                @endcan
                ...
                @if (Gate::check('Manage Email Templates'))
                    <li
                        ...
                        <a href="{{ route('email_template.index') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-mail"></i></span><span
                ...
                @if (Gate::check('Manage Coupons'))
                    <li
                        class="dash-item {{ Request::route()->getName() == 'coupons.index' || Request::route()->getName() == 'coupons.show' ? 'active' : '' }}">
                ...
                @if (Gate::check('System Settings') ||
                        Gate::check('Manage Pipelines') ||
                        Gate::check('Manage Sources') ||
                        Gate::check('Manage Payments') ||
                        Gate::check('Manage Expense Categories') ||
                        Gate::check('Manage Stages') ||
                        Gate::check('Manage Labels') ||
                        Gate::check('Manage Custom Fields') ||
                        Gate::check('Manage Contract Types') ||
                        Gate::check('Manage Email Templates'))
                    @if (Gate::check('Manage Pipelines'))
                        <li
                            class="dash-item dash-hasmenu {{ Request::route()->getName() == 'pipelines.index' ||
                            Request::route()->getName() == 'sources.index' ||
                            Request::route()->getName() == 'payments.index' ||
                            Request::route()->getName() == 'expense_categories.index' ||
                            Request::route()->getName() == 'stages.index' ||
                            Request::route()->getName() == 'labels.index' ||
                            Request::route()->getName() == 'custom_fields.index' ||
                            Request::route()->getName() == 'contract_type.index' ||
                            Request::route()->getName() == 'lead_stages.index' ||
                            Request::route()->getName() == 'email_template.index' ||
                            Request::route()->getName() == 'mdf_status.index' ||
                            Request::route()->getName() == 'mdf_type.index' ||
                            Request::route()->getName() == 'mdf_sub_type.index'
                                ? ''
                                : '' }} ">
                            <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    ...
                                    class="dash-mtext">{{ __('Setup') }}</span><span class="dash-arrow"><i
                                        data-feather="chevron-right"></i></span></a>
                            <ul
                                class="dash-submenu {{ Request::route()->getName() == 'pipelines.index' ||
                                Request::route()->getName() == 'sources.index' ||
                                Request::route()->getName() == 'payments.index' ||
                                Request::route()->getName() == 'expense_categories.index' ||
                                Request::route()->getName() == 'stages.index' ||
                                ...
                                @can('Manage Pipelines')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'pipelines.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('pipelines.index') }}">{{ __('Pipelines') }}</a>
                                    </li>
                                @endcan
                                @can('Manage Stages')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'stages.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('stages.index') }}">{{ __('Deal Stages') }}</a>
                                    </li>
                                @endcan
                                @can('Manage Lead Stages')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'lead_stages.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('lead_stages.index') }}">{{ __('Lead Stages') }}</a>
                                    </li>
                                @endcan
                                @can('Manage Labels')
                                    <li
                                ...
                                @can('Manage Sources')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'sources.index' ? 'active' : '' }}">
                                ...
                                @can('Manage Payments')
                                    <li
                                        ...
                                        <a class="dash-link"
                                            href="{{ route('payments.index') }}">{{ __('Payment Methods') }}</a>
                                    </li>
                                @endcan
                                @can('Manage Expense Categories')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'expense_categories.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('expense_categories.index') }}">{{ __('Expense Categories') }}</a>
                                    </li>
                                @endcan
                                ...
                                @can('Manage Taxes')
                                    <li
                                        ...
                                        <a href="{{ route('taxes.index') }}"
                                            class="dash-link">{{ __('Tax Rates') }}</a>
                                    </li>
                                @endcan
                                @can('Manage Custom Fields')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'custom_fields.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('custom_fields.index') }}">{{ __('Custom Fields') }}</a>
                                    </li>
                                @endcan
                                @can('Manage MDF Status')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'mdf_status.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('mdf_status.index') }}">{{ __('MDF Status') }}</a>
                                    </li>
                                @endcan
                                @can('Manage MDF Types')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'mdf_type.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('mdf_type.index') }}">{{ __('MDF Type') }}</a>
                                    </li>
                                @endcan
                                @can('Manage MDF Sub Types')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'mdf_sub_type.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('mdf_sub_type.index') }}">{{ __('MDF Sub Type') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                ...
                @can('System Settings')
                    <li class="dash-item {{ Request::route()->getName() == 'settings' ? 'active' : '' }}">
                        <a href="{{ route('settings') }}" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('System Settings') }}</span></a>
                    </li>
                @endcan
        ...
        <div class="card bg-primary">
            <div class="card-body">
                ...
                <img src="{{ asset('assets/images/sidebar-card.svg') }}" alt="" class="img-sidebar-card" />
            </div>
        </div>
    </div>
    </div>
