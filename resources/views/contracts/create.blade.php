...
<div class="modal-body">
    <div class="row">
        ...
        <div class="text-end">
            <a href="#" data-size="lg" class="btn btn-sm btn-primary btn-icon" data-ajax-popup-over="true" data-url="{{ route('generate',['contract']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Contract Name, Subject & Description') }}">
        ...
        <div class="col-md-6 form-group">
            ...
            {{ Form::select('client_name', $client,null, array('class' => 'form-control select2 multi-select','required'=>'required')) }}
        </div>
        <div class="col-md-6 form-group">
        ...
        <div class="col-md-6 form-group">
            ...
            {{ Form::number('value', '', array('class' => 'form-control','required'=>'required','min' => '1','placeholder'=>'Enter Value')) }}
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('notes', '', array('class' => 'form-control','placeholder'=>'Enter Description')) }}
            </div>
        </div>
