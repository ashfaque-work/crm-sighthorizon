...
@push('script')
    ...
    <script>
        ...
        function dropzoneBtn(file, response) {
            ...
            download.setAttribute('class', "action-btn bg-primary mx-1 mt-1 btn btn-sm d-inline-flex align-items-center");
            ...
            del.setAttribute('class', "action-btn bg-danger mx-1 mt-1 btn btn-sm d-inline-flex align-items-center");
...
@section('action-button')
    <div class="col-md-6 text-end d-flex">
        ...
        @endif
        @if ((\Auth::user()->type == 'Owner' && $contract->owner_signature == ''))
        <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-url="{{ route('signature', $contract->id) }}"
    ...
    @endif
        ...
        @if (((\Auth::user()->type == 'Client' && $contract->client_signature == '')) && $contract->status == 'accept')
            <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-url="{{ route('signature', $contract->id) }}"
                data-ajax-popup="true" data-title="{{ __('Signature') }}" data-size="md" title="{{ __('Signature') }}"
                data-bs-toggle="tooltip" data-bs-placement="top">
                <i class="ti ti-pencil"></i>
    ...
    <div class="row">
        <div class="col-12 mb-3">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-files-tab" data-bs-toggle="pill" href="#attachments" role="tab"
                        aria-controls="files" aria-selected="false">{{ __('Attachments') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-files-tab" data-bs-toggle="pill" href="#comments" role="tab"
                        aria-controls="files" aria-selected="false">{{ __('Comments') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-files-tab" data-bs-toggle="pill" href="#notes" role="tab"
                        aria-controls="files" aria-selected="false">{{ __('Notes') }}</a>
                </li>
            </ul>
        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="text-end">
                                            <a href="#" data-size="lg" class="btn btn-sm btn-primary btn-icon" data-ajax-popup-over="true" data-url="{{ route('generate',['contractdescription']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Contract Description') }}">
                                ...
                                <div class="card-body">
                                    ...
                                    @if (\Auth::user()->type == 'Owner')
                                        ...
                                        @if (\Auth::user()->type == 'Owner')
                                            <div class="col-md-12 float-end mb-0">
                            ...
                            <div class="card">
                                <div id="comment">
                                    ...
                                    <div class="card-footer">
                                        @if(\Auth::user()->enable_chatgpt())
                                        <div class="text-end" style="margin-right: 65px;">
                                            <a href="#" data-size="lg" class="btn btn-sm btn-primary btn-icon" data-ajax-popup-over="true" data-url="{{ route('generate',['contractcomment']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Contract Comment') }}">
                                                <i class="fas fa-robot"></i>{{ __(' Generate with AI') }}
                                            </a>
                                        </div>
                                        @endif
                            ...
                            <div id="notes">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="#!" data-size="md" class="btn btn-primary btn-icon btn-sm" data-ajax-popup-over="true" id="grammarCheck" data-url="{{ route('grammar',['contract']) }}"
                                        data-bs-placement="top" data-title="{{ __('Grammar check with AI') }}">
                                        <i class="ti ti-rotate"></i> <span>{{__('Grammar check with AI')}}</span>
                                        </a>
                                        <a href="#" data-size="lg" class="btn btn-sm btn-primary btn-icon" data-ajax-popup-over="true" data-url="{{ route('generate',['contractnote']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Contract Notes') }}">
                                            <i class="fas fa-robot"></i>{{ __(' Generate with AI') }}
                                        </a>
                                        </div>
                                        @endif
                                        @if ((\Auth::user()->type == 'Owner' || $contract->status == 'accept'))
                                            ...
                                            <div class="form-group">
                                                <textarea class="tox-target pc-tinymce summernotes grammer_textarea" style="width:100%" name="note" id="summernote"></textarea>
                                            </div>
