    ...
    <div class="row">
        <div class="col-12 mb-3">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#general" role="tab"
                        aria-controls="pills-home" aria-selected="true">{{ __('General') }}</a>
                </li>
                @if (Auth::user()->type != 'Super Admin' || in_array('Client View Tasks', $permission))
                    <li class="nav-item">
                        <a class="nav-link" id="pills-tasks-tab" data-bs-toggle="pill" href="#tasks" role="tab"
                            aria-controls="tasks" aria-selected="false">{{ __('Tasks') }}</a>
                    </li>
                @endif
                @if (Auth::user()->type != 'Super Admin' || in_array('Client View Products', $permission))
                    <li class="nav-item">
                        <a class="nav-link" id="pills-products-tab" data-bs-toggle="pill" href="#products" role="tab"
                            aria-controls="products" aria-selected="false">{{ __('Products') }}</a>
                    </li>
                @endif
                @if (Auth::user()->type != 'Super Admin' || in_array('Client View Sources', $permission))
                    <li class="nav-item">
                        <a class="nav-link" id="pills-sources-tab" data-bs-toggle="pill" href="#sources" role="tab"
                            aria-controls="sources" aria-selected="false">{{ __('Sources') }}</a>
                    </li>
                @endif
                @if (Auth::user()->type != 'Super Admin' || in_array('Client View Files', $permission))
                    <li class="nav-item">
                        <a class="nav-link" id="pills-files-tab" data-bs-toggle="pill" href="#files" role="tab"
                            aria-controls="files" aria-selected="false">{{ __('Files') }}</a>
                    </li>
                @endif
                <li class="nav-item">
                    <a class="nav-link" id="pills-discussion-tab" data-bs-toggle="pill" href="#discussion" role="tab"
                        aria-controls="discussion" aria-selected="false">{{ __('Discussion') }}</a>
                </li>

                @can('Edit Deal')
                    <li class="nav-item">
                        <a class="nav-link" id="pills-notes-tab" data-bs-toggle="pill" href="#notes" role="tab"
                            aria-controls="notes" aria-selected="false">{{ __('Notes') }}</a>
                    </li>
                @endcan
                @if (Auth::user()->type != 'Super Admin' || in_array('Client View Invoices', $permission))
                    <li class="nav-item">
                        <a class="nav-link" id="pills-invoices-tab" data-bs-toggle="pill" href="#invoices"
                            role="tab" aria-controls="invoices" aria-selected="false">{{ __('Invoices') }}</a>
                    </li>
                @endif
                @if (Auth::user()->type != 'Super Admin' || in_array('Client View Custom fields', $permission))
                    <li class="nav-item">
                        <a class="nav-link" id="pills-custom_fields-tab" data-bs-toggle="pill" href="#custom_fields"
                            role="tab" aria-controls="custom_fields"
                            aria-selected="false">{{ __('Custom Fields') }}</a>
                    </li>
                @endif
                @if (Auth::user()->type != 'Super Admin')
                    <li class="nav-item">
                        <a class="nav-link" id="pills-clients-tab" data-bs-toggle="pill" href="#clients" role="tab"
                            aria-controls="clients" aria-selected="false">{{ __('Clients') }}</a>
                    </li>
                @endif
                @if (Auth::user()->type != 'Super Admin')
                    <li class="nav-item">
                        <a class="nav-link" id="pills-calls-tab" data-bs-toggle="pill" href="#calls" role="tab"
                            aria-controls="calls" aria-selected="false">{{ __('Calls') }}</a>
                    </li>
                @endif
                @if (Auth::user()->type != 'Super Admin')
                    <li class="nav-item">
                        <a class="nav-link" id="pills-emails-tab" data-bs-toggle="pill" href="#emails" role="tab"
                            aria-controls="emails" aria-selected="false">{{ __('Emails') }}</a>
                    </li>
                @endif
        ...
        <div class="col-12">
            <div class="tab-content tab-bordered">
                <div class="tab-pane fade show active" id="general" role="tabpanel">
                    <div class="card">
                        <div class="card-header card-body d-flex align-items-start justify-content-between">
                            <ul class="nav nav-pills p-1">
                                <li class="nav-item p-1">
                                    <a href="#">{{ __('Price') }} <span
                                            class="badge rounded p-2 px-3 bg-primary">{{ \Auth::user()->priceFormat($deal->price) }}</span></a>
                                </li>
                                <li class="nav-item p-1">
                                    <a href="#">{{ __('Pipeline') }} <span
                                            class="badge rounded p-2 px-3 bg-success">{{ $deal->pipeline->name }}</span></a>
                                </li>
                                <li class="nav-item p-1">
                                    <a href="#">{{ __('Stage') }} <span
                                            class="badge rounded p-2 px-3 bg-warning">{{ $deal->stage->name }}</span></a>
                                </li>
                                <li class="nav-item p-1">
                                    <a href="#">{{ __('Created') }} <span
                                            class="badge rounded p-2 px-3 bg-secondary">{{ \Auth::user()->dateFormat($deal->created_at) }}</span></a>
                                </li>
                            </ul>
                            <ul class="nav nav-pills p-1">
                                @can('Edit Deal')
                                <li class="nav-item deal_status" data-toggle="tooltip"
                                    data-original-title="{{ __('Change Deal Status') }}">
                                    <span class="py-0">
                                        {{ Form::open(['route' => ['deals.change.status', $deal->id], 'id' => 'change-deal-status', 'style' => 'margin-right: 10px;']) }}
                        ...
                        @if (Auth::user()->type != 'Super Admin' || in_array('Client View Members', $permission))
                            <div class="col-xl-4 col-lg-4 col-sm-6 col-md-6">
                                <div class="card table-card deal-card">
                                    ...
                                    <div class="card-body pt-0 table-border-style bg-none deal-scroll">
                                        <div class="">
                                            <table class="table align-items-center mb-0">
                                                <tbody class="list">
                                                    @foreach ($deal->users as $user)
                                                        <tr>
                                                            <td>
                                                                <a href="{{ !empty($user->avatar) ? \App\Models\Utility::get_file($user->avatar) : $logo . 'avatar.png' }}"
                                                                    target="_blank">
                                                ...
                                                <tbody class="list">
                                                    ...
                                                    @if ($products)
                                                        @foreach ($products as $product)
                                                            <tr>
                                                                <td>
                                                                    <a href="{{ !empty($product->image) ? \App\Models\Utility::get_file($product->image) : \App\Models\Utility::get_file('product/img01.jpg') }}"
                                                                        target="_blank">
                                                                        <img src="{{ !empty($product->image) ? \App\Models\Utility::get_file($product->image) : \App\Models\Utility::get_file('product/img01.jpg') }}"
                        ...
                        @if (Auth::user()->type != 'Super Admin' || in_array('Client View Files', $permission))
                            <div class="col-lg-4">
                                <div class="card deal-card">
                                    ...
                                    <div class="card-body deal-scroll" style="overflow: auto;">
                                        <div>
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row" style="height:577px !important;overflow-y: scroll;">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-end" style="margin-right: 25px;">
                                            @if (\Auth::user()->enable_chatgpt())
                                                <a href="#!" data-size="md" class="btn btn-primary btn-icon btn-sm"
                                                    ...
                                                    data-url="{{ route('grammar', ['deal']) }}" data-bs-placement="top"
                                        ...
                                        <div class=" height-450">
                                            <form action="{{ route('deals.note.store', $deal->id) }}" method="POST">
                                                @csrf
                                                <div class="card-body bg-none ">
                                                    <textarea class="summernote" id="pc_demo1" name="notes">{!! $deal->notes !!}</textarea>
                                                </div>
                                                <div class="text-end" style="margin-right: 25px;">
                                            ...
                                            @foreach ($deal->discussions as $discussion)
                                                <li class="media">
                                                    <div style="margin-right: 10px;">
                                                        <a href="{{ !empty($discussion->user->avatar) ? \App\Models\Utility::get_file($discussion->user->avatar) : $logo . 'avatar.png' }}"
                                                            target="_blank">
                                                            <img src="{{ !empty($discussion->user->avatar) ? \App\Models\Utility::get_file($discussion->user->avatar) : $logo . 'avatar.png' }}"
                                                                class="img-fluid rounded-circle" width="30">
                                                        </a>
                                                    </div>
                                                    ...
                                                    @foreach ($customFields as $field)
                                                        <tr>
                                                            ...
                                                            @if (!empty($deal->customField))
                                                                <td>{{ isset($deal->customField[$field->id]) ? $deal->customField[$field->id] : '-' }}
                                                                </td>
                                                            @endif
                                                        </tr>
                                                    @endforeach
                                        ...
                                        <div class="card-header">
                                            <h5>{{ __('Clients') }}
                                                @can('Create Lead Call')
                                                    <a href="#" data-size="md" class="btn btn-sm btn-primary float-end "
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="{{ __('Add Client') }}"
                                                ...
                                                <table class="table mb-0 pc-dt-simple">
                                                    ...
                                                    <tbody>
                                                        @foreach ($deal->clients as $client)
                                                            <tr>
                                                                <td>
                                                                    <a href="{{ !empty($client->avatar) ? \App\Models\Utility::get_file($client->avatar) : $logo . 'avatar.png' }}"
                                                                        target="_blank">
                                                                        <img src="{{ !empty($client->avatar) ? \App\Models\Utility::get_file($client->avatar) : $logo . 'avatar.png' }}"
                                                                            class="img-fluid rounded-circle" width="30">
                                                                    </a>
                                                                <td>{{ $client->name }}</td>
                                                                <td>{{ $client->email }}</td>
                                                                <td class="text-end">
                                                                    @can('Edit Deal')
                                                                        <div class="action-btn bg-info ms-2">
                                                                            <a href="#" data-size="lg"
                                                                                data-url="{{ route('deals.client.permission', [$deal->id, $client->id]) }}"
                                                                                data-ajax-popup="true"
                                                                                data-title="{{ __('Permission') }}"
                                                                                class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                                title="{{ __('Permission') }}"><i
                                                                                    class="ti ti-lock text-white"></i></a>
                                                                        </div>
                                                                    @endcan
                                                                    @can('Edit Deal')
                                                                        <div class="action-btn bg-danger ms-2">
                                        ...
                                        <div class="card-header">
                                            <h5>{{ __('Calls') }}
                                                @can('Create Deal Call')
                                                    <a href="#" data-size="lg" class="btn btn-sm btn-primary float-end "
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="{{ __('Add Call') }}"
