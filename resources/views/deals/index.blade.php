    ...
    <div class="row align-items-center ">
        @if ($pipeline)
            <div class="col-auto pe-0">
                {{ Form::open(['route' => 'deals.change.pipeline', 'id' => 'change-pipeline', 'class' => 'mr-2']) }}
        ...
        <div class="col-auto pe-0">
            <a href="{{ route('deals.list') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                title="{{ __('List View') }}" class="btn btn-sm btn-primary btn-icon m-1"><i class="ti ti-list"></i> </a>
            <a href="{{ route('deals.export') }}" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip"
                                            ...
                                            <div class="card" data-id="{{ $deal->id }}">
                                                ...
                                                <div class="card-header border-0 pb-0 position-relative">
                                                    <h5><a href="@can('View Deal') @if ($deal->is_active) {{ route('deals.show', $deal->id) }} @else # @endif @else # @endcan"
                                                            class="text-body">{{ $deal->name }} </a></h5>
