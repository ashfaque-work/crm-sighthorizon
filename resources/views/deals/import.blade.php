     ...
     <div class="row">
         ...
         <div class="col-md-12 mb-6">
             {{Form::label('file',__('Download sample client CSV file'),['class'=>'col-form-label'])}}
                 <a href="{{asset(Storage::url('uploads/sample')).'/sample-client.xlsx'}}" class="btn btn-sm btn-primary btn-icon">
         ...
         <div class="col-md-12">
             ...
             <div class="choose-file form-group">
                 <label for="file" class="form-label choose-files bg-primary "><i
                     ...
                     <input type="file" class="custom-input-file d-none" name="file" id="file" data-filename="upload_file" required>
