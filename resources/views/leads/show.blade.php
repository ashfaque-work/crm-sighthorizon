                        ...
                        @if(Auth::user()->type != 'Client')
                            <div class="col-xl-4 col-lg-4 col-sm-6 col-md-6">
                                <div class="card table-card deal-card">
                                    <div class="card-header dark-btn-left">
                                        <h5>{{__('Users')}}
                                            @can('Edit Lead')
                                    ...
                                    <div class="card-body pt-0 table-border-style bg-none lead-scroll">
                                        <div class="">
                        ...
                        @if(Auth::user()->type != 'Client')
                            <div class="col-xl-4 col-lg-4 col-sm-6 col-md-6">
                                <div class="card table-card deal-card">
                                    ...
                                    <div class="card-body pt-0 table-border-style bg-none lead-scroll" style ="overflow: auto;">
                                        <div class="">
                                            <table class="table align-items-center mb-0">
                                                <tbody class="list">
                        ...
                        @if(Auth::user()->type != 'Client')
                            <div class="col-lg-4">
                                <div class="card table-card deal-card">
                                    ...
                                    <div class="card-body lead-scroll" style ="overflow: auto;">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-end" style="margin-right: 25px;">
                                            ...
                                            <a href="#!" data-size="md" class="btn btn-primary btn-icon btn-sm" data-ajax-popup-over="true" id="grammarCheck" data-url="{{ route('grammar',['lead']) }}"
                                        ...
                                        <div class=" height-450">
                                            <form action="{{route('leads.note.store',$lead->id)}}" method="POST">
                                                @csrf
                                                <div class="card-body bg-none ">
                                                    <textarea class="summernote" id="pc_demo1" name="notes">{!! $lead->notes !!}</textarea>
                                                </div>
                                                <div class="text-end" style="margin-right: 25px;">
