                            ...
                            <table class="table">
                                ...
                                <tbody>
                                            ...
                                            <div class="row">
                                                @if(in_array('System Settings',$permissions))
                                                    ...
                                                    <div class="col-4 form-check">
                                                        {{ Form::checkbox('permissions[]',$key,$role->permissions,['class' => 'form-check-input isscheck isscheck_account','id'=>'permission_'.$key]) }}
                                    ...
                                    @foreach($modules as $module)
                                        ...
                                        elseif($module == 'Manage Form Builders')
                                        {
                                            $s_name = 'Form Builder';
                                        }
                                        else
                                        ...
                                        <tr>
                                           <td width="10%">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input  align-middle ischeck" name="checkall" data-id="{{str_replace(' ', '', $module)}}" >
                                                </div>
                                            </td>
                                                ...
                                                <div class="row">
                                                    @if(in_array('Manage '.$s_name,$permissions))
                                                        ...
                                                        <div class="col-3 form-check">
                                                            {{ Form::checkbox('permissions[]',$key,$role->permissions,['class' => 'form-check-input isscheck isscheck_'.str_replace(' ', '', $module),'id'=>'permission_'.$key]) }}
                                                    ...
                                                    @endif
                                                    @if(in_array('Invoice '.$module,$permissions))
                                                    @php($key = array_search('Invoice '.$module, $permissions))
                                                    <div class="col-3 form-check">
                                                        {{ Form::checkbox('permissions[]',$key,$role->permissions,['class' => 'form-check-input isscheck isscheck_'.str_replace(' ', '', $module),'id'=>'permission_'.$key]) }}
                                                        {{ Form::label('permission_'.$key, __('Invoice'),['class'=>'form-check-labe font-weight-500']) }}
                                                    </div>
                                                @endif
                                                @if(in_array('Expense '.$module,$permissions))
                                                    @php($key = array_search('Expense '.$module, $permissions))
                                                    <div class="col-3 form-check">
                                                        {{ Form::checkbox('permissions[]',$key,$role->permissions,['class' => 'form-check-input isscheck isscheck_'.str_replace(' ', '', $module),'id'=>'permission_'.$key]) }}
                                                        {{ Form::label('permission_'.$key, __('Expense'),['class'=>'form-check-labe font-weight-500']) }}
                                                    </div>
                                                @endif
                                                @if(in_array('Income vs Expense '.$module,$permissions))
                                                    @php($key = array_search('Income vs Expense '.$module, $permissions))
                                                    <div class="col-3 form-check">
                                                        {{ Form::checkbox('permissions[]',$key,$role->permissions,['class' => 'form-check-input isscheck isscheck_'.str_replace(' ', '', $module),'id'=>'permission_'.$key]) }}
                                                        {{ Form::label('permission_'.$key, __('Income vs Expense'),['class'=>'form-check-labe font-weight-500']) }}
                                                    </div>
                                                @endif
                                                </div>
                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input align-middle ischeck" name="checkall" data-id="other" >
                                            </div>
                                        </td>
                                            ...
                                            <div class="row">
                                                @if(in_array('Manage Invoice Payments',$permissions))
                                                    ...
                                                    <div class="col-6 form-check">
                                                        {{ Form::checkbox('permissions[]',$key,$role->permissions,['class' => 'form-check-input isscheck isscheck_other','id'=>'permission_'.$key]) }}
                                                ...
                                                @endif
                                                @if(in_array('Manage Company Settings',$permissions))
                                                @php($key = array_search('Manage Company Settings', $permissions))
                                                <div class="col-6 form-check">
                                                    {{ Form::checkbox('permissions[]',$key,$role->permissions,['class' => 'form-check-input isscheck isscheck_other','id'=>'permission_'.$key]) }}
                                                    {{ Form::label('permission_'.$key, __('Manage Company Settings'),['class'=>'form-check-labe font-weight-500']) }}
                                                </div>
                                            @endif
                                            </div>
                                        </td>
