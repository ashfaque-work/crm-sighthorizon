    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                {{ Form::text('name', null, array('class' => 'form-control','placeholder'=>'Enter Role Name','required' => 'required')) }}
            </div>
        </div>
    </div>
    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            @if(in_array('Manage '.$s_name,$permissions))
                                                                ...
                                                                <div class="col-3 form-check">
                                                                    ...
                                                                    {{ Form::label('permission_'.$key, __('Manage'),['class'=>'form-check-labe font-weight-500']) }}
                                                                </div>
                                                            @endif
