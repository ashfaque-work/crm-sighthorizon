...
@section('action-button')
    <div class="row align-items-center m-1">
        ...
        <div class="col-auto pe-0">
            <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create Field')}}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Field')}}" data-url="{{ route('form.field.create',$formBuilder->id) }}"><i class="ti ti-plus text-white"></i></a>
        </div>
    </div>
@endsection
