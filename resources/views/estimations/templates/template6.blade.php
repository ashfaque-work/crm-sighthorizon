                            ...
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        ...
                                        <h3 data-v-4b3dcb8a="" class="sub-title">@if($settings['company_name']){{$settings['company_name']}}@endif</h3>
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-2" style="padding-left: 50px">
                                        <div data-v-4b3dcb8a="" class="col-66">
                                            ...
                                            <h3 data-v-4b3dcb8a="" class="sub-title">{{$client->name}}</h3>
                                ...
                                <div data-v-4b3dcb8a="" class="row" style="position: relative">
                                    <div data-v-4b3dcb8a="" class="col-lg-12">
                                        <table data-v-4b3dcb8a="" class="summary-table">
                                         ...
                                         <table data-v-4b3dcb8a="" class="summary-table" style="position: absolute;
                                            right: 0; top: -37px;">
                                            <tbody data-v-4b3dcb8a="" style="position: relative;">
