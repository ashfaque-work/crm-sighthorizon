@php
    $settings_data = \App\Models\Utility::settings($estimation->id)
@endphp
...
@if(\Auth::check())
    ...
    @else
      @php
        $usr=App\Models\User::where('id',$estimation->created_by)->first();
     @endphp
    @endif
                                        ...
                                        <div data-v-7d9d14b5="" class="">
                                            <table data-v-7d9d14b5="" class="no-space" style="width:50%">
                                                ...
                                                <tr data-v-7d9d14b5="">
                                                    ...
                                                    <td data-v-7d9d14b5="" class="">{{$usr->estimateNumberFormat($estimation->estimation_id)}}</td>
                                                </tr>
                                                <tr data-v-7d9d14b5="">
                                                    <td data-v-7d9d14b5="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Issue Date')}}:</td>
                                                    <td data-v-7d9d14b5="" class="">{{$usr->dateFormat($estimation->issue_date)}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div data-v-7d9d14b5="" class="break-25"></div>
                                    ...
                                    <div data-v-7d9d14b5="" class="row">
                                        ...
                                        <div class="" style="width: 20%">
                                            <p> {!! DNS2D::getBarcodeHTML(route('pay.estimation',\Illuminate\Support\Facades\Crypt::encrypt($estimation->estimation_id)), "QRCODE",2,2) !!}</p>
                                       </div>
                                    </div>
