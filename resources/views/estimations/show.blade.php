                         ...
                         <div class="row invoive-info d-print-inline-flex">
                            <div class="col-sm-4 invoice-client-info">
                               ...
                               @if($estimation->status == 0)
                                    <span class="badge rounded p-2 px-3 bg-secondary">{{ __(\App\Models\Estimation::$statues[$estimation->status]) }}</span>
                            ...
                            <div class="col-md-6 text-end">
                                @can('Estimation Add Product')
                                    <div class="btn btn-sm btn-primary btn-icon mt-1">
                                        ...
                                        <a href="#" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Add Estimation Product')}}" data-ajax-popup="true" data-size="lg" data-title="{{__('Add Estimation Product & Services')}}" data-url="{{ route('estimations.products.add',$estimation->id) }}"><i class="ti ti-plus text-white"></i></a>
