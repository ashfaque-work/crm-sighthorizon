                                        ...
                                        <td class="Action">
                                            ...
                                            @can('Edit MDF Status')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" data-size="md" data-url="{{ route('mdf_status.edit',$status->id) }}" data-ajax-popup="true" data-title="{{__('Edit MDF Status')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit Custom Field')}}" ><i class="ti ti-pencil text-white"></i></a>
                                                    </div>
                                                @endcan
                                                {{-- @if(count($statuses) > 1) --}}
