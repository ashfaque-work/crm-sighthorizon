...
<head>
<title>{{(Utility::getValByName('header_text')) ? Utility::getValByName('header_text') : config('app.name', 'Sight Horizon')}} &dash; @yield('title')</title>
...
<meta name="title" content="{{ isset($settings['meta_keywords']) && $settings['meta_keywords'] ? $settings['meta_keywords'] : '' }}">
<meta name="description" content="{{ isset($settings['meta_description']) && $settings['meta_description'] ? $settings['meta_description'] : '' }}">
<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="{{ env('APP_URL') }}">
<meta property="og:title" content="{{ isset($settings['meta_keywords']) && $settings['meta_keywords'] ? $settings['meta_keywords'] : '' }}">
<meta property="og:description" content="{{ isset($settings['meta_description']) && $settings['meta_description'] ? $settings['meta_description'] : '' }}">
<meta property="og:image" content="{{ $logo . 'meta_image.png' }}">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="{{ env('APP_URL') }}">
<meta property="twitter:title" content="{{ isset($settings['meta_keywords']) && $settings['meta_keywords'] ? $settings['meta_keywords'] : '' }}">
<meta property="twitter:description" content= "{{ isset($settings['meta_description']) && $settings['meta_description'] ? $settings['meta_description'] : '' }}">
