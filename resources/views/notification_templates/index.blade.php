    ...
    <div class="text-end mb-3">
        <div class="text-end">
            <div class="d-flex justify-content-end drp-languages">
                ...
                <a href="#" data-size="lg" class="btn btn-invoice btn-primary btn-icon" data-ajax-popup-over="true" data-url="{{ route('generate',['notification template']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}"
                style="margin-top: 7px;" data-title="{{ __('Generate Notification Content') }}">
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <h5 class= "font-weight-bold pb-3">{{ __('Placeholders') }}</h5>
                    ...
                    {{Form::model($curr_noti_tempLang,array('route' => array('notification_template.update', $curr_noti_tempLang->parent_id), 'method' => 'PUT')) }}
                    <div class="row">
