    ...
    <div class="row align-items-center m-1">
        @can('Create Source')
            <div class="col-auto pe-0">
                <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create Source')}}" data-ajax-popup="true" data-size="md" data-title="{{__('Create Source')}}" data-url="{{route('sources.create')}}"><i class="ti ti-plus text-white"></i></a>
            </div>
        @endcan
    </div>
@endsection
