...
<head>
    ...
    <style type="text/css">p[data-v-37eeda86] {
        ...
        .d-table-controls[data-v-1ad6e3b9] {
            -webkit-box-flex: 5;
            flex: 1;
        }
    ...
    <style type="text/css">p[data-v-b8f60a0c] {
        ...
        .d-table-value[data-v-1ad6e3b9] {
            padding-right: 6px;
        }
        .d-table-label[data-v-1ad6e3b9] {
            flex: 2;
        }
        </style>
                            ...
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9="" src="{{$img}}" class="d-logo" style="max-width: 200px;"> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <strong data-v-1ad6e3b9="" class="sub-title">{{$mdf->user->name}}</strong>
                                        <pre data-v-1ad6e3b9="">{{$mdf->user->email}}</pre>
                                    </div>
                                    <div data-v-1ad6e3b9="" class="col-33">&nbsp;</div>
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('MDF')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            ...
                                            <tr data-v-1ad6e3b9="">
                                                ...
                                                <td data-v-1ad6e3b9="" class="text-right">{{$usr->mdfNumberFormat($mdf->mdf_id)}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Status')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$mdf->statusDetail->name}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Type')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$mdf->typeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Sub Type')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$mdf->subTypeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Event Date')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$usr->dateFormat($mdf->date)}}</td>
                                            </tr>
                                                ...
                                                @if(isset($mdf->getProducts) && count($mdf->getProducts) > 0)
                                                    @foreach($mdf->getProducts as $key => $item)
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$usr->priceFormat($item->price)}}</span></div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-2" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$item->quantity}}</span></div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3 text-right" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$usr->priceFormat(($item->quantity > 0) ? $item->price * $item->quantity : $item->price)}}</span></div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-1ad6e3b9="" class="d-table-tr">
                                            ...
                                            <div data-v-1ad6e3b9="" class="d-table-footer">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-summary">
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label">{{__('Subtotal')}}:</div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($mdf->getSubTotal())}}</div>
                                                    </div>
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label"><strong data-v-1ad6e3b9="">{{__('Requested Amount')}}:</strong></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value"><strong data-v-1ad6e3b9="">{{$usr->priceFormat($mdf->amount)}}</strong></div>
                                                    </div>
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label">{{__('Approved Amount')}}:</div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($mdf->getFundAmt())}}</div>
                                                    </div>
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label">{{__('Available Amount')}}:</div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($mdf->getDue())}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
