                ...
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-7d9d14b5="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};padding:30px;">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-3"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('MDF')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{$usr->mdfNumberFormat($mdf->mdf_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{$usr->dateFormat($mdf->date)}}</p>
                                    </div>
                                ...
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <p data-v-7d9d14b5="">{{$mdf->user->name}}</p>
                                        <pre data-v-7d9d14b5="">{{$mdf->user->email}}</pre>
                                    </div>
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <div data-v-7d9d14b5="" class="padd"><strong data-v-7d9d14b5="" class="mb5">{{__('To')}}:</strong>
                                            <p data-v-7d9d14b5="" class="sub-title">@if($settings['company_name']){{$settings['company_name']}}@endif</p>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <table data-v-7d9d14b5="" class="summary-table">
                                            ...
                                            <tr data-v-7d9d14b5="">
                                                <td data-v-7d9d14b5="" class="fwb">{{__('Status')}}:</td>
                                                <td data-v-7d9d14b5="" class="text-right">{{$mdf->statusDetail->name}}</td>
                                            </tr>
                                            <tr data-v-7d9d14b5="">
                                                <td data-v-7d9d14b5="" class="fwb">{{__('Type')}}:</td>
                                                <td data-v-7d9d14b5="" class="text-right">{{$mdf->typeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-7d9d14b5="">
                                                <td data-v-7d9d14b5="" class="fwb">{{__('Sub Type')}}:</td>
                                                <td data-v-7d9d14b5="" class="text-right">{{$mdf->subTypeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-7d9d14b5="">
                                                <td data-v-7d9d14b5="" class="fwb">{{__('Event Date')}}:</td>
                                                <td data-v-7d9d14b5="" class="text-right">{{$usr->dateFormat($mdf->date)}}</td>
                                            </tr>
                                            ...
                                            @if(isset($mdf->getProducts) && count($mdf->getProducts) > 0)
                                                @foreach($mdf->getProducts as $key => $item)
                                                    <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                        ...
                                                        <div data-v-7d9d14b5="" class="d-table-td w-3" style="padding: 3px;"><span data-v-7d9d14b5="">{{$usr->priceFormat($item->price)}}</span></div>
                                                        <div data-v-7d9d14b5="" class="d-table-td w-2" style="padding: 3px;"><span data-v-7d9d14b5="">{{$item->quantity}}</span></div>
                                                        <div data-v-7d9d14b5="" class="d-table-td w-3 text-right" style="padding: 3px;"><span data-v-7d9d14b5="">{{$usr->priceFormat(($item->quantity > 0) ? $item->price * $item->quantity : $item->price)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                        ...
                                        <div data-v-7d9d14b5="" class="d-table-footer">
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-summary">
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Subtotal')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($mdf->getSubTotal())}}</div>
                                                </div>
                                                <div data-v-7d9d14b5="" class="d-table-summary-item" style="background: {{$color}}; color: {{$font_color}};">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Requested Amount')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($mdf->amount)}}</div>
                                                </div>
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Approved Amount')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($mdf->getFundAmt())}}</div>
                                                </div>
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Available Amount')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$usr->priceFormat($mdf->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
