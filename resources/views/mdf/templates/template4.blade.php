                        ...
                        <div data-v-363339a0="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-3"><h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('MDF')}}</h1>
                                        <p data-v-363339a0="">{{$mdf->user->name}}</p>
                                        <pre data-v-363339a0="">{{$mdf->user->email}}</pre>
                                    </div>
                                    ...
                                    <div data-v-363339a0="" class="col-33">
                                        <table data-v-363339a0="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{$usr->mdfNumberFormat($mdf->mdf_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Status')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$mdf->statusDetail->name}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Type')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$mdf->typeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Sub Type')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$mdf->subTypeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Event Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$usr->dateFormat($mdf->date)}}</td>
                                            </tr>
                                            ...
                                            @if(isset($mdf->getProducts) && count($mdf->getProducts) > 0)
                                                @foreach($mdf->getProducts as $key => $item)
                                                    <div data-v-363339a0="" class="d-table-tr">
                                                        ...
                                                        <div data-v-363339a0="" class="d-table-td w-3"><span data-v-363339a0="">{{$usr->priceFormat($item->price)}}</span></div>
                                                        <div data-v-363339a0="" class="d-table-td w-2"><span data-v-363339a0="">{{$item->quantity}}</span></div>
                                                        <div data-v-363339a0="" class="d-table-td w-3 text-right"><span data-v-363339a0="">{{$usr->priceFormat(($item->quantity > 0) ? $item->price * $item->quantity : $item->price)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-363339a0="" class="d-table-tr">
                                        ...
                                        <div data-v-363339a0="" class="d-table-footer">
                                            ...
                                            <div data-v-363339a0="" class="d-table-summary">
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($mdf->getSubTotal())}}</div>
                                                </div>
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="fwb f-b tu d-table-label" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Requested Amount')}}:</div>
                                                    <div data-v-363339a0="" class="fwb f-b d-table-value" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{$usr->priceFormat($mdf->amount)}}</div>
                                                </div>
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="tu d-table-label">{{__('Approved Amount')}}:</div>
                                                    <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($mdf->getFundAmt())}}</div>
                                                </div>
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="tu d-table-label">{{__('Available Amount')}}:</div>
                                                    <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($mdf->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
