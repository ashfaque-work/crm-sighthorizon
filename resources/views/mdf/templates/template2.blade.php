                            ...
                            <div data-v-37eeda86="" class="d-inner">
                                <div data-v-37eeda86="" class="row">
                                    ...
                                    <div data-v-37eeda86="" class="col-2 text-right">
                                        <strong class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Request From')}}:</strong>
                                        <p>{{$mdf->user->name}}<br>
                                            {{$mdf->user->email}}
                                        </p>
                                    </div>
                                ...
                                <div data-v-37eeda86="" class="row">
                                    ...
                                    <div data-v-37eeda86="" class="col-33"><strong data-v-37eeda86="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('MDF')}}</strong>
                                        <table data-v-37eeda86="" class="summary-table">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{$usr->mdfNumberFormat($mdf->mdf_id)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Status')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{$mdf->statusDetail->name}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Type')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{$mdf->typeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Sub Type')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{$mdf->subTypeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Event Date')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{$usr->dateFormat($mdf->date)}}</td>
                                            </tr>
                                        ...
                                        <div data-v-37eeda86="" class="d-table-footer">
                                            ...
                                            <div class="d-table-summary">
                                                <div class="d-table-summary-item">
                                                    <div class="tu d-table-label" style="padding-right: 91px;">{{__('Subtotal')}}:</div>
                                                    <div
                                                        class="d-table-value">{{$usr->priceFormat($mdf->getSubTotal())}}</div>
                                                </div>
                                                <div class="d-table-summary-item">
                                                    <div class="tu d-table-label">{{__('Requested Amount')}}:</div>
                                                    <div class="d-table-value">{{$usr->priceFormat($mdf->amount)}}</div>
                                                </div>
                                                <div class="d-table-summary-item"
                                                     style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    <div class="tu d-table-label">{{__('Approved Amount')}}:</div>
                                                    <div class="d-table-value">{{$usr->priceFormat($mdf->getFundAmt())}}</div>
                                                </div>
                                                <div class="d-table-summary-item"
                                                     style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    <div class="tu d-table-label">{{__('Available Amount')}}:</div>
                                                    <div class="d-table-value">{{$usr->priceFormat($mdf->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
