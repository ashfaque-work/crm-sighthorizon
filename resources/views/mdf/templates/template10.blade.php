                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33"><h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-top: 15px solid {{$color}};">{{__('MDF')}}</h1></div>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Request From')}}:</strong>
                                        <p data-v-b8f60a0c="">{{$mdf->user->name}}</p>
                                        <pre data-v-b8f60a0c="">{{$mdf->user->email}}</pre>
                                    </div>
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{$usr->mdfNumberFormat($mdf->mdf_id)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Status')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$mdf->statusDetail->name}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Type')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$mdf->typeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Sub Type')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$mdf->subTypeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Event Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$usr->dateFormat($mdf->date)}}</td>
                                            </tr>
                                            ...
                                            @if(isset($mdf->getProducts) && count($mdf->getProducts) > 0)
                                                @foreach($mdf->getProducts as $key => $item)
                                                    <div data-v-b8f60a0c="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-b8f60a0c="" class="d-table-td w-3"><span data-v-b8f60a0c="">{{$usr->priceFormat($item->price)}}</span></div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-2"><span data-v-b8f60a0c="">{{$item->quantity}}</span></div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-3 text-right"><span data-v-b8f60a0c="">{{$usr->priceFormat(($item->quantity > 0) ? $item->price * $item->quantity : $item->price)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-b8f60a0c="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                        ...
                                        <div data-v-b8f60a0c="" class="d-table-footer">
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-summary">
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    <div data-v-b8f60a0c="" class="tu d-table-label">{{__('Subtotal')}}:</div>
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$usr->priceFormat($mdf->getSubTotal())}}</div>
                                                </div>
                                                <div data-v-b8f60a0c="" class="d-table-summary-item" style="color: {{$font_color}}; background: {{$color}};">
                                                    <div data-v-b8f60a0c="" class="tu d-table-label">{{__('Requested Amount')}}:</div>
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$usr->priceFormat($mdf->amount)}}</div>
                                                </div>
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    <div data-v-b8f60a0c="" class="tu d-table-label">{{__('Approved Amount')}}:</div>
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$usr->priceFormat($mdf->getFundAmt())}}</div>
                                                </div>
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    <div data-v-b8f60a0c="" class="tu d-table-label">{{__('Available Amount')}}:</div>
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$usr->priceFormat($mdf->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
