                        ...
                        <div data-v-e23d9750="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><h1 data-v-e23d9750="" class="fancy-title tu mb5" style="background: {{$color}};color: {{$font_color}}">{{__('MDF')}}</h1></div>
                                    <div data-v-e23d9750="" class="col-33">
                                        <img data-v-e23d9750="" src="{{$img}}" class="d-logo">
                                        <div data-v-e23d9750="" class="break-25"></div>
                                        <p data-v-e23d9750="">{{$mdf->user->name}}</p>
                                        <pre data-v-e23d9750="">{{$mdf->user->email}}</pre>
                                    </div>
                                </div>
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-right">{{$usr->mdfNumberFormat($mdf->mdf_id)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Status')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{$mdf->statusDetail->name}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Type')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{$mdf->typeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Sub Type')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{$mdf->subTypeDetail->name}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Event Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{$usr->dateFormat($mdf->date)}}</td>
                                            </tr>
                                            ...
                                            @if(isset($mdf->getProducts) && count($mdf->getProducts) > 0)
                                                @foreach($mdf->getProducts as $key => $item)
                                                    <div data-v-e23d9750="" class="d-table-tr">
                                                        ...
                                                        <div data-v-e23d9750="" class="d-table-td w-3"><span data-v-e23d9750="">{{$usr->priceFormat($item->price)}}</span></div>
                                                        <div data-v-e23d9750="" class="d-table-td w-2"><span data-v-e23d9750="">{{$item->quantity}}</span></div>
                                                        <div data-v-e23d9750="" class="d-table-td w-3 text-right"><span data-v-e23d9750="">{{$usr->priceFormat(($item->quantity > 0) ? $item->price * $item->quantity : $item->price)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-e23d9750="" class="d-table-tr">
                                        ...
                                        <div data-v-e23d9750="" class="d-table-footer">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-summary">
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="tu d-table-label">{{__('Subtotal')}}:</div>
                                                    <div data-v-e23d9750="" class="d-table-value">{{$usr->priceFormat($mdf->getSubTotal())}}</div>
                                                </div>
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="fwb f-b tu d-table-label">{{__('Requested Amount')}}:</div>
                                                    <div data-v-e23d9750="" class="fwb f-b d-table-value">{{$usr->priceFormat($mdf->amount)}}</div>
                                                </div>
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="tu d-table-label">{{__('Approved Amount')}}:</div>
                                                    <div data-v-e23d9750="" class="d-table-value">{{$usr->priceFormat($mdf->getFundAmt())}}</div>
                                                </div>
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="tu d-table-label">{{__('Available Amount')}}:</div>
                                                    <div data-v-e23d9750="" class="d-table-value">{{$usr->priceFormat($mdf->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
