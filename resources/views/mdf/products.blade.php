...
<div class="row">
    <div class="col-12 py-3">
        <div class="d-flex radio-check">
            <div class="form-check m-1">
                ...
                <label class="form-check-label" for="product_service_radio">{{__('Product & Serivces')}}</label>
            </div>
            <div class="form-check m-1">
    ...
    <div id="product_service" class="col-12">
        <div class="form-group">
            ...
            {{ Form::select('product_id', $products,null, array('class' => 'form-control select2 multi-select','required'=>'required')) }}
        </div>
        <div class="form-group">
            {{ Form::label('quantity', __('Quantity'),['class'=>'form-control-label']) }}
            {{ Form::number('quantity', isset($product)?null:1, array('class' => 'form-control','min'=>'1','required'=>'required')) }}
        </div>
    </div>
    <div id="others" class="d-none col-12">
        ...
        <div class="form-group">
            ...
            {{ Form::number('price', null, array('class' => 'form-control','min'=>'1','required'=>'required')) }}
        </div>
    </div>
    <div class="col-12 form-group">
        {{ Form::label('description', __('Description'),['class'=>'form-control-label']) }}
        {{ Form::textarea('description', isset($product)?null:'', array('class' => 'form-control','required'=>'required')) }}
    </div>
</div>
</div>
