...
@php
  $lang = isset($users->lang) ? $users->lang : 'en';
    ...
    $LangName = App\Models\languages::where('code',$currEmailTempLang->lang)->first();
...
@section('action-button')
        <div class="text-end mb-3">
            <div class="d-flex justify-content-end drp-languages">
                <ul class="list-unstyled mb-0 m-2">
                    <li class="dropdown dash-h-item drp-language" style="list-style-type: none;">
                        ...
                        <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                            @foreach(Utility::languages() as $code  => $lang)
                            <a href="{{route('manageemail.lang',[$emailTemplate->id,$code])}}" class="dropdown-item {{($currEmailTempLang->lang  == $lang) ? 'text-primary' : '' }}">
                ...
                <a href="#" data-size="lg" class="btn btn-invoice btn-primary btn-icon" data-ajax-popup-over="true" data-url="{{ route('generate',['email template']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}"
                style="margin-top: 7px;" data-title="{{ __('Generate Email Content') }}">
